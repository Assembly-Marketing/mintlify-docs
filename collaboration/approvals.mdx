...
The **Approvals** page in the sidebar gives you a centralized view:
...
Filter by date range to focus on what's urgent. Click any row to open the post and take action.
...
2. **Review** — Check the copy, media, mentions, hashtags, and schedule
3. **Respond**:
   - **Approve** — Click the checkmark. The requester is notified and the post can be scheduled.
   - **Withdraw** — If you change your mind after approving, you can revoke your approval.

Leave comments directly on the post if you have feedback—the author will be notified.
...
<Note>
**Enterprise feature:** On Enterprise plans, admins can configure default approval rules that apply workspace-wide. This ensures certain accounts never publish without review—even if someone forgets to request approval manually.
</Note>
